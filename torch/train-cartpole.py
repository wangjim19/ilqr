...
torch.save(model.state_dict(), 'torch/saved-models/cartpole/state-dict.pt')

with open('torch/saved-models/cartpole/train_losses.txt', 'w') as f:
    np.savetxt(f, np.array(train_loss_history))
with open('torch/saved-models/cartpole/test_losses.txt', 'w') as f:
