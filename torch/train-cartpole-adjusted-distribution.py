...
torch.save(model.state_dict(), 'torch/saved-models/cartpole-adjusted-distribution/state-dict.pt')

with open('torch/saved-models/cartpole-adjusted-distribution/train_losses.txt', 'w') as f:
    np.savetxt(f, np.array(train_loss_history))
with open('torch/saved-models/cartpole-adjusted-distribution/test_losses.txt', 'w') as f:
